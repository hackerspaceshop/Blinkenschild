 ...
 *
 * Code from Android BluetoothChat sample.
 */
...
//                    bytes = mmInStream.read(buffer);
                    c = (char) mmInStream.read();
                    if (c == '\n') {
                        // full line received
                        // Send the obtained bytes to the UI Activity
                        mHandler.obtainMessage(MainActivity.MESSAGE_READ, sb.length(), -1, sb.toString())
                                .sendToTarget();
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mmOutStream.write(0xD); // BlinkenSchildCommands specific - terminate line with CR
