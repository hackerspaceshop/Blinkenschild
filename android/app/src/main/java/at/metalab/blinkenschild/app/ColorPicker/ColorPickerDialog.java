package at.metalab.blinkenschild.app.ColorPicker;
...
public class ColorPickerDialog {
	 ...
	 */
	public ColorPickerDialog(final Context context, int color, ColorPickerListener listener) {
		this.listener = listener;
		Color.colorToHSV(color, currentColorHsv);

		final View view = LayoutInflater.from(context).inflate(R.layout.dialog_colorpicker, null);
        ...
        viewNewColor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (ColorPickerDialog.this.listener != null) {
                    ColorPickerDialog.this.listener.onNewColorClick(ColorPickerDialog.this, getColor());
                }
            }
        });
