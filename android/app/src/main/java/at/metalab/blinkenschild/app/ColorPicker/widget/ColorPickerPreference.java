package at.metalab.blinkenschild.app.ColorPicker.widget;
...
public class ColorPickerPreference extends Preference {
	...
	public ColorPickerPreference(Context context, AttributeSet attrs) {
		super(context, attrs);
		setWidgetLayoutResource(R.layout.pref_widget_colorpicker);
	}
	...
	@Override protected void onClick() {
		new ColorPickerDialog(getContext(), value, new ColorPickerDialog.ColorPickerListener() {
